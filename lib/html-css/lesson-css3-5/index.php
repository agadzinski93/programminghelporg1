	...
	<?php require_once "/home/users/web/b1812/ipg.programminghelporg1/files/adAbove.php"; ?>
		...
		<div class="mainVideoContainer">
			<div class="videoTitleContainer">
				<div class="prev vidLink"><a href="http://www.programminghelp.org/lib/html-css/lesson-css3-4/"><span class="vidLinkText">PREV</span></a></div>
				<div class="videoTitle vidLink"><a href="http://www.youtube.com/watch?v=wkdCwydJoqk"><span class="vidLinkText">5 - Parent/Child Selectors and Classes</span></a></div>
				<div class="next vidLink"><a href="http://www.programminghelp.org/lib/html-css/lesson-css3-6/"><span class="vidLinkText">NEXT</span></a></div>
			</div>
			<div class="videoContainer">
				<iframe width="640" height="360" src="//www.youtube.com/embed/wkdCwydJoqk" frameborder="0" allowfullscreen></iframe>
			</div>
			...
			<div class="videoDescription">
				...
				<p class="description">In this tutorial, we will learn about how to modify specific tags that are within other tags and we will learn about classes.</p>
			</div>
		</div>
	</div>
