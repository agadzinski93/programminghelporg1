	...
	<?php require_once "/home/users/web/b1812/ipg.programminghelporg1/files/adAbove.php"; ?>
		...
		<div class="mainVideoContainer">
			<div class="videoTitleContainer">
				<div class="prev vidLink"><a href="http://www.programminghelp.org/lib/html-css/lesson-9/"><span class="vidLinkText">PREV</span></a></div>
				<div class="videoTitle vidLink"><a href="http://www.youtube.com/watch?v=6-AkfJzdllE"><span class="vidLinkText">10 - Forms</span></a></div>
				<div class="next vidLink"><a href="http://www.programminghelp.org/lib/html-css/lesson-11/"><span class="vidLinkText">NEXT</span></a></div>
			</div>
			<div class="videoContainer">
				<iframe width="640" height="360" src="//www.youtube.com/embed/6-AkfJzdllE" frameborder="0" allowfullscreen></iframe>
			</div>
			...
			<div class="videoDescription">
				...
				<p class="description">In this tutorial, we will learn how to create forms and a bunch of different input types for use with the form.</p>
			</div>
		</div>
	</div>
