	...
	<?php require_once "/home/users/web/b1812/ipg.programminghelporg1/files/adAbove.php"; ?>
		...
		<div class="mainVideoContainer">
			<div class="videoTitleContainer">
				<div class="prev vidLink"><a href="http://www.programminghelp.org/lib/html-css/lesson-css3-9/"><span class="vidLinkText">PREV</span></a></div>
				<div class="videoTitle vidLink"><a href="http://www.youtube.com/watch?v=1SwJ6iE6_tY"><span class="vidLinkText">10 - Structuring a Website with DIV Tags</span></a></div>
				<div class="next vidLink"></div>
			</div>
			<div class="videoContainer">
				<iframe width="640" height="360" src="//www.youtube.com/embed/1SwJ6iE6_tY" frameborder="0" allowfullscreen></iframe>
			</div>
			...
			<div class="videoDescription">
				...
				<p class="description">This tutorial will cover how to properly organize and structure a website using DIV (division) tags about each section of the page. We will wrap the entire one DIV tag known as the container.</p>
			</div>
		</div>
	</div>
