	...
	<?php require_once "/home/users/web/b1812/ipg.programminghelporg1/files/adAbove.php"; ?>
		...
		<div class="mainVideoContainer">
			<div class="videoTitleContainer">
				...
				<div class="videoTitle vidLink"><a href="http://www.youtube.com/watch?v=_WKBRw9wk-8"><span class="vidLinkText">1 - Introduction in Cascading Style Sheets</span></a></div>
				<div class="next vidLink"><a href="http://www.programminghelp.org/lib/html-css/lesson-css3-2/"><span class="vidLinkText">NEXT</span></a></div>
			</div>
			<div class="videoContainer">
				<iframe width="640" height="360" src="//www.youtube.com/embed/_WKBRw9wk-8" frameborder="0" allowfullscreen></iframe>
			</div>
			...
			<div class="videoDescription">
				...
				<p class="description">We will review the differences between inline, embedded (internal), and external style sheets.</p>
			</div>
		</div>
	</div>
