	...
	<?php require_once "/home/users/web/b1812/ipg.programminghelporg1/files/adAbove.php"; ?>
		...
		<div class="mainVideoContainer">
			<div class="videoTitleContainer">
				<div class="prev vidLink"><a href="http://www.programminghelp.org/lib/c-sharp/lesson-1/"><span class="vidLinkText">PREV</span></a></div>
				<div class="videoTitle vidLink"><a href="http://www.youtube.com/watch?v=RMDSJyoYwg0"><span class="vidLinkText">2 - Controls, Comments, Variables, Data Types</span></a></div>
				<div class="next vidLink"><a href="http://www.programminghelp.org/lib/c-sharp/lesson-3/"><span class="vidLinkText">NEXT</span></a></div>
			</div>
			<div class="videoContainer">
				<iframe width="640" height="360" src="//www.youtube.com/embed/RMDSJyoYwg0" frameborder="0" allowfullscreen></iframe>
			</div>
			...
			<div class="videoDescription">
				...
				<p class="description">In this tutorial, we will learn about controls for the GUI, how to create comments, how to declare and initialize variables, and various data types from floating types to string types.</p>
			</div>
		</div>
	</div>
