	...
	<?php require_once "/home/users/web/b1812/ipg.programminghelporg1/files/adAbove.php"; ?>
		...
		<div class="mainVideoContainer">
			<div class="videoTitleContainer">
				<div class="prev vidLink"><a href="http://www.programminghelp.org/lib/c-sharp/lesson-11/"><span class="vidLinkText">PREV</span></a></div>
				<div class="videoTitle vidLink"><a href="http://www.youtube.com/watch?v=_2dwQWvlJO4"><span class="vidLinkText">12 - Static Variables and Multiple Forms</span></a></div>
				<div class="next vidLink"><a href="http://www.programminghelp.org/lib/c-sharp/lesson-13/"><span class="vidLinkText">NEXT</span></a></div>
			</div>
			<div class="videoContainer">
				<iframe width="640" height="360" src="//www.youtube.com/embed/_2dwQWvlJO4" frameborder="0" allowfullscreen></iframe>
			</div>
			...
			<div class="videoDescription">
				...
				<p class="description">This tutorial will cover how to use static variables and what their advantages are as well as how to create and open multiple forms.</p>
			</div>
		</div>
	</div>
