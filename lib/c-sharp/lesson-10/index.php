	...
	<?php require_once "/home/users/web/b1812/ipg.programminghelporg1/files/adAbove.php"; ?>
		...
		<div class="mainVideoContainer">
			<div class="videoTitleContainer">
				<div class="prev vidLink"><a href="http://www.programminghelp.org/lib/c-sharp/lesson-9/"><span class="vidLinkText">PREV</span></a></div>
				<div class="videoTitle vidLink"><a href="http://www.youtube.com/watch?v=R5NBIlw8rk4"><span class="vidLinkText">10 - Functions, Parameters, and Variable Scope</span></a></div>
				<div class="next vidLink"><a href="http://www.programminghelp.org/lib/c-sharp/lesson-11/"><span class="vidLinkText">NEXT</span></a></div>
			</div>
			<div class="videoContainer">
				<iframe width="640" height="360" src="//www.youtube.com/embed/R5NBIlw8rk4" frameborder="0" allowfullscreen></iframe>
			</div>
			...
			<div class="videoDescription">
				...
				<p class="description">This tutorial will cover how to declare and implement functions. I will also show you how to pass parameters into functions and discuss a bit on variable scope.</p>
			</div>
		</div>
	</div>
