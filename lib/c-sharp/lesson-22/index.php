	...
	<?php require_once "/home/users/web/b1812/ipg.programminghelporg1/files/adAbove.php"; ?>
		...
		<div class="mainVideoContainer">
			<div class="videoTitleContainer">
				<div class="prev vidLink"><a href="http://www.programminghelp.org/lib/c-sharp/lesson-21/"><span class="vidLinkText">PREV</span></a></div>
				<div class="videoTitle vidLink"><a href="http://www.youtube.com/watch?v=GIcgONHznuU"><span class="vidLinkText">22 - Introduction to the Graphical User Interface</span></a></div>
				<div class="next vidLink"><a href="http://www.programminghelp.org/lib/c-sharp/lesson-23/"><span class="vidLinkText">NEXT</span></a></div>
			</div>
			<div class="videoContainer">
				<iframe width="640" height="360" src="//www.youtube.com/embed/GIcgONHznuU" frameborder="0" allowfullscreen></iframe>
			</div>
			...
			<div class="videoDescription">
				...
				<p class="description">Here, we will learn as many controls as we can including: group boxes, check boxes, checklist boxes, radio buttons, combo boxes, numeric ups and downs, picture boxes, richtext boxes, tooltips, link labels, and more!</p>
			</div>
		</div>
	</div>
