	...
	<?php require_once "/home/users/web/b1812/ipg.programminghelporg1/files/adAbove.php"; ?>
		...
		<div class="mainVideoContainer">
			<div class="videoTitleContainer">
				<div class="prev vidLink"><a href="http://www.programminghelp.org/lib/c++/lesson-5/"><span class="vidLinkText">PREV</span></a></div>
				<div class="videoTitle vidLink"><a href="http://www.youtube.com/watch?v=61TH8qfjC5I"><span class="vidLinkText">6 -  If Statements and Comparison and Logical Operators</span></a></div>
				<div class="next vidLink"><a href="http://www.programminghelp.org/lib/c++/lesson-7/"><span class="vidLinkText">NEXT</span></a></div>
			</div>
			<div class="videoContainer">
				<iframe width="640" height="360" src="//www.youtube.com/embed/61TH8qfjC5I" frameborder="0" allowfullscreen></iframe>
			</div>
			...
			<div class="videoDescription">
				...
				<p class="description">This tutorial will cover decision making via if and else if statements as well as use of the logical and comparison operators: && || ^</p>
			</div>
		</div>
	</div>
