	...
	<?php require_once "/home/users/web/b1812/ipg.programminghelporg1/files/adAbove.php"; ?>
		...
		<div class="mainVideoContainer">
			<div class="videoTitleContainer">
				<div class="prev vidLink"><a href="http://www.programminghelp.org/lib/c++/lesson-1/"><span class="vidLinkText">PREV</span></a></div>
				<div class="videoTitle vidLink"><a href="http://www.youtube.com/watch?v=6_2OaaTi-Lw"><span class="vidLinkText">2 - Comments, Variables, Data Types</span></a></div>
				<div class="next vidLink"><a href="http://www.programminghelp.org/lib/c++/lesson-3/"><span class="vidLinkText">NEXT</span></a></div>
			</div>
			<div class="videoContainer">
				<iframe width="640" height="360" src="//www.youtube.com/embed/6_2OaaTi-Lw" frameborder="0" allowfullscreen></iframe>
			</div>
			...
			<div class="videoDescription">
				...
				<p class="description">This tutorial will cover how to create comments and various data types you can assign to variables such as integers, doubles, floats, chars, strings, and Boolean.</p>
			</div>
		</div>
	</div>
