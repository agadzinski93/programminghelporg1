	...
	<?php require_once "/home/users/web/b1812/ipg.programminghelporg1/files/adAbove.php"; ?>
		...
		<div class="mainVideoContainer">
			<div class="videoTitleContainer">
				<div class="prev vidLink"><a href="http://www.programminghelp.org/lib/c++/lesson-27/"><span class="vidLinkText">PREV</span></a></div>
				<div class="videoTitle vidLink"><a href="http://www.youtube.com/watch?v=NvVYd08NUXI"><span class="vidLinkText">28 -  Recursion</span></a></div>
				<div class="next vidLink"><a href="http://www.programminghelp.org/lib/c++/lesson-29/"><span class="vidLinkText">NEXT</span></a></div>
			</div>
			<div class="videoContainer">
				<iframe width="640" height="360" src="//www.youtube.com/embed/NvVYd08NUXI" frameborder="0" allowfullscreen></iframe>
			</div>
			...
			<div class="videoDescription">
				...
				<p class="description">This tutorial will cover how to use recursive statements in your program. It will also illustrate the difference between iteration and recursion as well as explain when one should be used over the other. We will also be introduced to stacks.</p>
			</div>
		</div>
	</div>
