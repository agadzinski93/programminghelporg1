	...
	<?php require_once "/home/users/web/b1812/ipg.programminghelporg1/files/adAbove.php"; ?>
		...
		<div class="mainVideoContainer">
			<div class="videoTitleContainer">
				<div class="prev vidLink"><a href="http://www.programminghelp.org/lib/c++/lesson-20-1/"><span class="vidLinkText">PREV</span></a></div>
				<div class="videoTitle vidLink"><a href="http://www.youtube.com/watch?v=b9wialxvcVA"><span class="vidLinkText">20-2 -  Classes and Object-Oriented Programming (Part 2)</span></a></div>
				<div class="next vidLink"><a href="http://www.programminghelp.org/lib/c++/lesson-21/"><span class="vidLinkText">NEXT</span></a></div>
			</div>
			<div class="videoContainer">
				<iframe width="640" height="360" src="//www.youtube.com/embed/b9wialxvcVA" frameborder="0" allowfullscreen></iframe>
			</div>
			...
			<div class="videoDescription">
				...
				<p class="description">This tutorial will finish up what we started in the last tutorial. Here, we will create our destructor, create our accessor functions and mutator functions, and create a function to calculate BMI (body mass index). I hope the tutorial is helpful.</p>
			</div>
		</div>
	</div>
