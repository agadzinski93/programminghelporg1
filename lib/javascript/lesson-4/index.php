	...
	<?php require_once "/home/users/web/b1812/ipg.programminghelporg1/files/adAbove.php"; ?>
		...
		<div class="mainVideoContainer">
			<div class="videoTitleContainer">
				<div class="prev vidLink"><a href="http://www.programminghelp.org/lib/javascript/lesson-3/"><span class="vidLinkText">PREV</span></a></div>
				<div class="videoTitle vidLink"><a href="http://www.youtube.com/watch?v=KQJ-cXq-jG4"><span class="vidLinkText">4 - Decision Making, Logical & Comparison Operators, Nesting</span></a></div>
				<div class="next vidLink"><a href="http://www.programminghelp.org/lib/javascript/lesson-5/"><span class="vidLinkText">NEXT</span></a></div>
			</div>
			<div class="videoContainer">
				<iframe width="640" height="360" src="//www.youtube.com/embed/KQJ-cXq-jG4" frameborder="0" allowfullscreen></iframe>
			</div>
			...
			<div class="videoDescription">
				...
				<p class="description">We will learn about how to make decisions with if statements as well as nesting them. We will also learn about comparison and logical operators.</p>
			</div>
		</div>
	</div>
