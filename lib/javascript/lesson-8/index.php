	...
	<?php require_once "/home/users/web/b1812/ipg.programminghelporg1/files/adAbove.php"; ?>
		...
		<div class="mainVideoContainer">
			<div class="videoTitleContainer">
				<div class="prev vidLink"><a href="http://www.programminghelp.org/lib/javascript/lesson-7/"><span class="vidLinkText">PREV</span></a></div>
				<div class="videoTitle vidLink"><a href="http://www.youtube.com/watch?v=65sIDcRDhgQ"><span class="vidLinkText">8 - Functions, Parameters, and Variable Scope</span></a></div>
				<div class="next vidLink"><a href="http://www.programminghelp.org/lib/javascript/lesson-9/"><span class="vidLinkText">NEXT</span></a></div>
			</div>
			<div class="videoContainer">
				<iframe width="640" height="360" src="//www.youtube.com/embed/65sIDcRDhgQ" frameborder="0" allowfullscreen></iframe>
			</div>
			...
			<div class="videoDescription">
				...
				<p class="description">In this tutorial, we will learn about functions, when to use parameters with functions, and local and global scope for variables.</p>
			</div>
		</div>
	</div>
