	...
	<?php require_once "/home/users/web/b1812/ipg.programminghelporg1/files/adAbove.php"; ?>
		...
		<div class="mainVideoContainer">
			<div class="videoTitleContainer">
				<div class="prev vidLink"><a href="http://www.programminghelp.org/lib/javascript/lesson-2/"><span class="vidLinkText">PREV</span></a></div>
				<div class="videoTitle vidLink"><a href="http://www.youtube.com/watch?v=dXBuWTrEV_Y"><span class="vidLinkText">3 - Arithmetic (Math) and Assignment Operators</span></a></div>
				<div class="next vidLink"><a href="http://www.programminghelp.org/lib/javascript/lesson-4/"><span class="vidLinkText">NEXT</span></a></div>
			</div>
			<div class="videoContainer">
				<iframe width="640" height="360" src="//www.youtube.com/embed/dXBuWTrEV_Y" frameborder="0" allowfullscreen></iframe>
			</div>
			...
			<div class="videoDescription">
				...
				<p class="description">An introduction in operators that can be used in JavaScript.</p>
			</div>
		</div>
	</div>
