	...
	<?php require_once "/home/users/web/b1812/ipg.programminghelporg1/files/adAbove.php"; ?>
		...
		<div class="mainVideoContainer">
			<div class="videoTitleContainer">
				...
				<div class="videoTitle vidLink"><a href="http://www.youtube.com/watch?v=23m_IWPCrVs"><span class="vidLinkText">1 - Introduction in JavaScript</span></a></div>
				<div class="next vidLink"><a href="http://www.programminghelp.org/lib/javascript/lesson-2/"><span class="vidLinkText">NEXT</span></a></div>
			</div>
			<div class="videoContainer">
				<iframe width="640" height="360" src="//www.youtube.com/embed/23m_IWPCrVs" frameborder="0" allowfullscreen></iframe>
			</div>
			...
			<div class="videoDescription">
				...
				<p class="description">Just an overview of what this playlist will be about. Not so much with the programming until the next video.</p>
			</div>
		</div>
	</div>
