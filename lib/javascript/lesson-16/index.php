	...
	<?php require_once "/home/users/web/b1812/ipg.programminghelporg1/files/adAbove.php"; ?>
		...
		<div class="mainVideoContainer">
			<div class="videoTitleContainer">
				<div class="prev vidLink"><a href="http://www.programminghelp.org/lib/javascript/lesson-15/"><span class="vidLinkText">PREV</span></a></div>
				<div class="videoTitle vidLink"><a href="http://www.youtube.com/watch?v=gqgH9qmhsck"><span class="vidLinkText">16 - More on Arrays and the Image Object</span></a></div>
				<div class="next vidLink"><a href="http://www.programminghelp.org/lib/javascript/lesson-17/"><span class="vidLinkText">NEXT</span></a></div>
			</div>
			<div class="videoContainer">
				<iframe width="640" height="360" src="//www.youtube.com/embed/gqgH9qmhsck" frameborder="0" allowfullscreen></iframe>
			</div>
			...
			<div class="videoDescription">
				...
				<p class="description">In this tutorial, we will learn about methods and properties concerning arrays as well as the image object and preloading images.</p>
			</div>
		</div>
	</div>
