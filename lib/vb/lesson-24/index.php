...
<?php require_once "/home/users/web/b1812/ipg.programminghelporg1/files/jsOff.php"; ?>
	...
	<title>Visual Basic | Lesson 24</title>
</head>
	...
	<?php require_once "/home/users/web/b1812/ipg.programminghelporg1/files/adAbove.php"; ?>
		...
		<div class="mainVideoContainer">
			<div class="videoTitleContainer">
				<div class="prev vidLink"><a href="http://www.programminghelp.org/lib/vb/lesson-23/"><span class="vidLinkText">PREV</span></a></div>
				<div class="videoTitle vidLink"><a href="http://www.youtube.com/watch?v=lbL7feP4COY"><span class="vidLinkText">24 - Dates, Track Bars, and Menus</span></a></div>
				<div class="next vidLink"></div>
			</div>
			<div class="videoContainer">
				<iframe width="640" height="360" src="//www.youtube.com/embed/lbL7feP4COY" frameborder="0" allowfullscreen></iframe>
			</div>
			...
			<div class="videoDescription">
				...
				<p class="description">Here we will learn how to use the date object with the DateTimePicker control as well as use the track bars, We will also briefly look at HScrollBars and VScrollBars and create menu strips with separators and shortcut keys.</p>
			</div>
		</div>
	</div>
