...
<?php require_once "/home/users/web/b1812/ipg.programminghelporg1/files/jsOff.php"; ?>
	...
	<title>Visual Basic | Lesson 3</title>
</head>
	...
	<?php require_once "/home/users/web/b1812/ipg.programminghelporg1/files/adAbove.php"; ?>
		...
		<div class="mainVideoContainer">
			<div class="videoTitleContainer">
				<div class="prev vidLink"><a href="http://www.programminghelp.org/lib/vb/lesson-2/"><span class="vidLinkText">PREV</span></a></div>
				<div class="videoTitle vidLink"><a href="http://www.youtube.com/watch?v=FhsKk3BBoto"><span class="vidLinkText">3 - Buttons, Textboxes, Boxes, and Arithmetic and Assignment Operators</span></a></div>
				<div class="next vidLink"><a href="http://www.programminghelp.org/lib/vb/lesson-4/"><span class="vidLinkText">NEXT</span></a></div>
			</div>
			<div class="videoContainer">
				<iframe width="640" height="360" src="//www.youtube.com/embed/FhsKk3BBoto" frameborder="0" allowfullscreen></iframe>
			</div>
			...
			<div class="videoDescription">
				...
				<p class="description">We will learn a few more controls on the windows form GUI as well as the math and assignment operators.</p>
			</div>
		</div>
	</div>
