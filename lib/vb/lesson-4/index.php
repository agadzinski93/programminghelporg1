...
<?php require_once "/home/users/web/b1812/ipg.programminghelporg1/files/jsOff.php"; ?>
	...
	<title>Visual Basic | Lesson 4</title>
</head>
	...
	<?php require_once "/home/users/web/b1812/ipg.programminghelporg1/files/adAbove.php"; ?>
		...
		<div class="mainVideoContainer">
			<div class="videoTitleContainer">
				<div class="prev vidLink"><a href="http://www.programminghelp.org/lib/vb/lesson-3/"><span class="vidLinkText">PREV</span></a></div>
				<div class="videoTitle vidLink"><a href="http://www.youtube.com/watch?v=AAzUsZdoBrM"><span class="vidLinkText">4 - If Statements and Comparison and Logical Operators</span></a></div>
				<div class="next vidLink"><a href="http://www.programminghelp.org/lib/vb/lesson-5/"><span class="vidLinkText">NEXT</span></a></div>
			</div>
			<div class="videoContainer">
				<iframe width="640" height="360" src="//www.youtube.com/embed/AAzUsZdoBrM" frameborder="0" allowfullscreen></iframe>
			</div>
			...
			<div class="videoDescription">
				...
				<p class="description">Conditional logic using the infamous if statement as well as using comparison and logical operators with these statements.</p>
			</div>
		</div>
	</div>
